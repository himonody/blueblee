...
type UserModel struct {
	...
	ArticleModel []ArticleModel   `gorm:"foreignKey:AuthID" json:"-"`          //发布的文章列表
	CollectModel []ArticleModel   `gorm:"many2many:user_collect_model;joinForeignKey;UserID;JoinReferences:ArticleID" json:"-"`
	//SitModels    []SitModel       `gorm:"many2many:auth_sites" json:"-"`
}
